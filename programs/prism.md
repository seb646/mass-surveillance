...
<div style="padding: 10px 0;border: 1px solid rgb(233, 236, 239);border-radius: 5px;width: 80%;margin: auto;">
    <img src="/archive/prism.png" alt="A diagram of PRISM's collection functionality" width="100%"><br> 
    <span style="padding-top: 10px;display: block;text-align: center;border-top: 1px solid rgb(233, 236, 239);">A diagram of PRISM's collection functionality. <a href="#sources">[1]</a></span>
</div>
...
<div style="padding: 10px;border: 1px solid #e9ecef;border-radius: 5px;">
    <iframe width="100%" height="404" src="https://www.youtube-nocookie.com/embed/CRYMgZvbxm4?start=16" title="Edward Snowden talking about the NSA's PRISM program" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>
    <span style="margin-top: 5px;display: block;text-align: center;">Edward Snowden talking about the NSA's PRISM program. <a href="#sources">[2]</a></span>
</div>
...
2. *Edward Snowden: PRISM not just about metadata*. CBS News, 2014. [https://www.youtube.com/watch?v=CRYMgZvbxm4](https://www.youtube.com/watch?v=CRYMgZvbxm4).